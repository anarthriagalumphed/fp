        ...
        <table style="width: 100%;margin-top:-4cm">
            ...
            <tr>
                <td style="width: 100px;text-align:center" colspan="4" class="td-no-left-right-border">
                    <img src="<?= base_url('aset/img/amikom.png') ?>" alt="Logo" style="width: 300px;">
                </td>
            </tr>
            <tr>
                <td style="width: 100px;text-align:center" colspan="4" class="td-no-left-right-border">
                    <h2 style="margin:0px">Mata Kuliah: <?= $rps->nama_matkul ?> (<?= $rps->kode_matkul ?>) </h2>
                </td>
            </tr>
            <tr>
                <td style="width: 100px;text-align:center" colspan="4" class="td-no-left-right-border">
            ...
            <tr>
                ...
                <td style="text-align:center">
                    <i><?= date('Y', strtotime($rps->tgl_berlaku)) ?></i>
                </td>
                <td style="text-align:center">
                    <i><?= date('d M Y', strtotime($rps->tgl_dosen)) ?></i>
                </td>
                <td style="text-align:center" class="td-no-left-right-border">
                    <i><?= $rps->revisi ?></i>
                </td>
            ...
            <tr>
                ...
                <td style="text-align:center">
                    <div style="height:80px;"></div>
                    <b><u><?= $rps->nama_dosen_penyusun ?></u></b>
                    <br>
                    NIK.<?= $rps->nik_dosen_penyusun ?>
                </td>
                <td style="text-align:center" class="td-no-left-right-border">
                    <div style="height:80px;"></div>
        ...
        <table style="width: 100%;">
            <tr>
                <td style="text-align: center; width: 100px;" rowspan="4">
                    <img src="<?= base_url('aset/img/amikom.png') ?>" alt="Logo" style="width: 150px;">
                </td>
                <td style="text-align: center;" rowspan="4">
                    <h3 style="margin:0px;">Rencana Pembelajaran Semester</h3>
                    <h3 style="margin:0px;">Program Studi:<?= $rps->nama_prodi ?> </h3>
                    <h3 style="margin:0px;">Mata Kuliah: <?= $rps->nama_matkul ?> </h3>
            ...
            <div>
                ...
                <table style="width: 100%; font-size:14px">
                    ...
                    <tr>
                        ...
                        <td>
                            <?= $rps->nama_matkul ?> |<?= $rps->kode_matkul ?>
                        </td>
                        <td>
                            Bobot SKS
                        </td>
                ...
                <?= $rps->prasyarat_dan_pengetahuan_awal ?>
                <div style="background-color:grey;margin-bottom:20px;margin-top:20px">
                ...
                <table style="width: 100%;font-size:14px">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <?= $rps->kemampuan_akhir_yang_diharapkan ?>
                            </td>
                            <td>
                                <?= $rps->indikator ?>
                            </td>
                ...
                <table style="width: 100%;font-size:14px">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <?= $rps->kemampuan_akhir_yang_diharapkan_atau_evaluasi ?>
                            </td>
                            <td>
                                <?= $rps->waktu ?>
                            </td>
                            ...
                            <td>
                                <?= $rps->kriteria_penilaian ?>
                            </td>
                            <td>
                                <?= $rps->indikator_penilaian ?>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <i style="margin-bottom:20px;"><?= $rps->referensi ?></i>
                </tbody>
                <div style="background-color:grey;margin-bottom:20px;margin-top:20px">
                ...
                <table style="width: 100%;font-size:14px">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <?= $rps->minggu_atau_pertemuan ?>
                            </td>
                            <td>
                                <?= $rps->kemampuan_akhir_yang_diharapkan_2 ?>
                            </td>
                            <td>
                                <?= $rps->indikator_2 ?>
                            </td>
                            <td>
                                <?= $rps->topik_dan_subtopik ?>
                            </td>
                            <td>
                                <?= $rps->aktifitas_dan_strategi_pembelajaran ?></td>
                            <td>
                                100 menit
                            </td>
                        </tr>
